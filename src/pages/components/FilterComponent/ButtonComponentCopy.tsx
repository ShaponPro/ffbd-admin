...
const ButtonComponentCopy = (props: Props) => {
    const styleButton = (type: string, isActive: boolean) => {
        ...
        if (type === "select-custom") {
            return {
                ...
                boxShadow: isActive
                    ? "1px 1px 3px rgba(22, 31, 41, 0.2)"
                    : "inset 1px 1.5px 5px rgba(22, 31, 41, 0.1)",
                fontFamily: "Open Sans",
                fontSize: "14px",
                fontWeight: isActive ? "700" : "400",
                color: isActive ? "#FFFFFF" : "#161F29",
...
export default ButtonComponentCopy;

ButtonComponentCopy.defaultProps = {
    title: "",
    type: "",
    style: {},
    onClick: () => null,
